...
object ModBlocks {
    ...
    val FLESH_BOX: Identifier = Identifier.of(BiologicalManipulation.MOD_ID, "flesh_box")
    ...
    fun register(block: Block, name: String, shouldRegisterItem: Boolean): Block {
        ...
        val id: Identifier = Identifier.of(BiologicalManipulation.MOD_ID, name)
