package com.novvux.biomanipulation.item.armor
...
object ModArmorMaterials {
    ...
    fun registerMaterial(
        ...
        val layers = listOf<ArmorMaterial.Layer>(ArmorMaterial.Layer(Identifier.of(BiologicalManipulation.MOD_ID, id), "", dyeable))
        ...
        material = Registry.register(Registries.ARMOR_MATERIAL, Identifier.of(BiologicalManipulation.MOD_ID, id), material)
