...
class SarkicismDataGenerator : DataGeneratorEntrypoint {
	...
	private class ModTagGenerator(output: FabricDataOutput, completableFuture: CompletableFuture<WrapperLookup>) :
		...
		val MODIFICATOR: TagKey<Item> = TagKey.of(RegistryKeys.ITEM, Identifier.of(Sarkicism.MOD_ID, "modificator"))
		val CRYSTAL: TagKey<Item> = TagKey.of(RegistryKeys.ITEM, Identifier.of(Sarkicism.MOD_ID, "crystal"))
		val TIER0CRYSTAL: TagKey<Item> = TagKey.of(RegistryKeys.ITEM, Identifier.of(Sarkicism.MOD_ID, "tier0crystal"))
		val TIER1CRYSTAL: TagKey<Item> = TagKey.of(RegistryKeys.ITEM, Identifier.of(Sarkicism.MOD_ID, "tier1crystal"))
		val TIER2CRYSTAL: TagKey<Item> = TagKey.of(RegistryKeys.ITEM, Identifier.of(Sarkicism.MOD_ID, "tier2crystal"))
		val TIER3CRYSTAL: TagKey<Item> = TagKey.of(RegistryKeys.ITEM, Identifier.of(Sarkicism.MOD_ID, "tier3crystal"))
