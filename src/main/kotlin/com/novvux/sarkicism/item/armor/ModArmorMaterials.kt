package com.novvux.sarkicism.item.armor
...
object ModArmorMaterials {
    ...
    fun registerMaterial(
        ...
        val layers = listOf<ArmorMaterial.Layer>(ArmorMaterial.Layer(Identifier.of(Sarkicism.MOD_ID, id), "", dyeable))
        ...
        material = Registry.register(Registries.ARMOR_MATERIAL, Identifier.of(Sarkicism.MOD_ID, id), material)
