package com.novvux.sarkicism.sarkicism
...
class BodyScreenHandler @JvmOverloads constructor(syncId: Int, playerInventory: PlayerInventory, inventory: Inventory = SimpleInventory(9)):
    ScreenHandler(Sarkicism.FLESH_BOX_SCREEN_HANDLER, syncId) {
