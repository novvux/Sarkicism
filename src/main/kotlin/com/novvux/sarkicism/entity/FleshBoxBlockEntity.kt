...
/*
class FleshBoxBlockEntity(pos: BlockPos, state: BlockState): BlockEntity(ModEntities.FLESH_BOX_BLOCK_ENTITY, pos, state), NamedScreenHandlerFactory, IImplementedInventory {
    //From the IImplementedInventory Interface
...
class FleshBoxBlockEntity(pos: BlockPos, state: BlockState): BlockEntity(ModEntities.FLESH_BOX_BLOCK_ENTITY, pos, state), NamedScreenHandlerFactory,
    IImplementedInventory {
    override val items: DefaultedList<ItemStack> = DefaultedList.ofSize(9, ItemStack.EMPTY)
    override fun markDirty() {
